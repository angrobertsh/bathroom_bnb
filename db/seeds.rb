...
Bathroom.create(description: "3rd and 7th 14th floor unicrapper", gender: "women", lat: 10.8, lng: 12, single: false, accessible: false)
...
#   url: "api/bathrooms",
#   method: "POST",
#   data: {bathroom: {description: "a wonderous fountain of purity", lat: 1, lng: 2, single: true, gender: "men", tags: "lovely, filthy, Glory"}},
